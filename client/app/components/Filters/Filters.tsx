...
const Filters = () => {
  ...
  return (
    <div className="relative py-2 px-2 grid grid-cols-4 items-center gap-3 bg-[#F9F9F9] border-2 border-white rounded-md">
      <span className="absolute left-[5px] bg-[#EDEDED] rounded-md transition-all duration-300" style={getIndicatorStyle()}></span>
      ...
      {priorities.map((priority, index) => (
        <button
          ...
          onClick={() => {
            ...
            setPriority(priority === "All" ? null : priority.toLowerCase());
          }}
        >
          {priority}
        </button>
